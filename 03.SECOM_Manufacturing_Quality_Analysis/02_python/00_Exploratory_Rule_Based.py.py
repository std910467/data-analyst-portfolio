# %%
# Exploratory Rule-Based Analysis
# 此程式為 Project 3 初期探索紀錄。
# 使用完整資料進行特徵篩選、threshold 探索與 Rule-Based 規則建立，
# 因未進行 Train/Test 分離，因此結果不納入後續正式模型比較。
import pandas as pd
...
# save_result("00_Exploratory_Rule_Based", TP, FP, FN, TN)